...
from utils.metrics import compute_mpjpe, compute_metrics
    ...
    def train_epoch(self, epoch: int) -> Tuple[float, float]:
        ...
        for batch_idx, (input_seq, target_seq, actions, crashes) in enumerate(pbar):
            ...
            if batch_idx % 100 == 0:
                ...
                self.writer.add_scalar('train/mpjpe', mpjpe.item(), self.global_step)
...
if __name__ == "__main__":
    ...
    # Hyperparameters
    INPUT_FRAMES = 10
    OUTPUT_FRAMES = 12  # 0.5 seconds @ 25 fps
